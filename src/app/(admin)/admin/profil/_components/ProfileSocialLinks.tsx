        ...
        <div className="bg-neutral-900 p-6 rounded-lg">
            ...
            <div className="flex flex-col gap-3">
                <input
                    ...
                    onChange={(e) => setProfile({ ...profile, url_portfolio: e.target.value })}
                ...
                <input
                    ...
                    onChange={(e) => setProfile({ ...profile, url_linkedin: e.target.value })}
                    className="bg-neutral-800 border border-neutral-700 p-2 rounded"
                />
                ...
                <input
                    ...
                    onChange={(e) => setProfile({ ...profile, url_github: e.target.value })}
                    className="bg-neutral-800 border border-neutral-700 p-2 rounded"
                />
            </div>
        </div>
